...
class		Cart extends ObjectModel
{
	...
	public function containsProduct($id_product, $id_product_attribute, $id_customization, $instructions)
	{
		return Db::getInstance()->getRow('
			...
			WHERE cp.`id_product` = '.intval($id_product).' AND cp.`id_product_attribute` = '.intval($id_product_attribute).' AND cp.`id_cart` = '.intval($this->id). ' AND cp.instructions = "'.$instructions.'"'.
