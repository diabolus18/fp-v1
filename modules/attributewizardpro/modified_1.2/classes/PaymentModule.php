				...
				foreach ($products AS $key => $product)
				{
					...
					if (isset($customizedDatas[$product['id_product']][$product['id_product_attribute']]))
					{
						...
						'<tr style="background-color:'.($key%2 ? '#DDE2E6' : '#EBECEE').';">
							...
							<td style="padding:0.6em 0.4em;"><strong>'.$product['name'].(isset($product['attributes_small']) ? ' '.$product['attributes_small'] : '').(isset($product['instructions']) ? ' '.$product['instructions'] : '').' - '.$this->l('Customized').'</strong></td>
