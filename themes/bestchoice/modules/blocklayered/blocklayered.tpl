...
<div id="layered_block_left" class="block">
	<h4 class="title_block">{l s='Shop by' mod='blocklayered'}</h4>
	...
	<div id="layered_ajax_loader" style="display: none;">
		<p class="layered_ajax_loader_icon"><img src="{$img_ps_dir}loader.gif" alt="" /><br />{l s='Loading...' mod='blocklayered'}</p>
	</div>
</div>
{else}
<div id="layered_block_left" class="block">
