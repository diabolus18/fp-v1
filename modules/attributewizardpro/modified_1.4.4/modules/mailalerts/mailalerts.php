		...
		foreach ($products AS $key => $product)
		{
			...
			$itemsTable .=
				'<tr style="background-color:'.($key % 2 ? '#DDE2E6' : '#EBECEE').';">
					...
					<td style="padding:0.6em 0.4em;"><strong>'.$product['product_name'].(isset($product['attributes_small']) ? ' '.$product['attributes_small'] : '').(isset($product['instructions']) ? ' '.$product['instructions'] : '').'</strong></td>
