...
{if isset($lastProductAdded) AND $lastProductAdded}
	<div class="cart_last_product">
		...
		<a  class="cart_last_product_img" href="{$link->getProductLink($lastProductAdded.id_product, $lastProductAdded.link_rewrite, $lastProductAdded.category, null, null, $lastProductAdded.id_shop)|escape:'htmlall':'UTF-8'}{if $lastProductAdded.instructions_valid != ''}{if $awp_url_rewrite}?{else}&{/if}ipa={$lastProductAdded.id_product_attribute}&ins={$lastProductAdded.instructions_valid}{/if}"><img src="{$link->getImageLink($lastProductAdded.link_rewrite, $lastProductAdded.id_image, 'small_default')}" alt="{$lastProductAdded.name|escape:'htmlall':'UTF-8'}"/></a>
		<div class="cart_last_product_content">
			<p class="s_title_block"><a href="{$link->getProductLink($lastProductAdded.id_product, $lastProductAdded.link_rewrite, $lastProductAdded.category, null, null, null, $lastProductAdded.id_product_attribute)|escape:'htmlall':'UTF-8'}{if $lastProductAdded.instructions_valid != ''}{if $awp_url_rewrite}?{else}&{/if}ipa={$lastProductAdded.id_product_attribute}&ins={$lastProductAdded.instructions_valid}{/if}">{$lastProductAdded.name|escape:'htmlall':'UTF-8'}</a></p>
			{if isset($lastProductAdded.attributes) && $lastProductAdded.attributes}<a href="{$link->getProductLink($lastProductAdded.id_product, $lastProductAdded.link_rewrite, $lastProductAdded.category, null, null, null, $lastProductAdded.id_product_attribute)|escape:'htmlall':'UTF-8'}{if $lastProductAdded.instructions_valid != ''}{if $awp_url_rewrite}?{else}&{/if}ipa={$lastProductAdded.id_product_attribute}&ins={$lastProductAdded.instructions_valid}{/if}">{$lastProductAdded.attributes|escape:'htmlall':'UTF-8'}</a>{/if}
			{if isset($lastProductAdded.instructions) && $lastProductAdded.instructions}{if $lastProductAdded.attributes}<br />{/if}<a href="{$link->getProductLink($lastProductAdded.id_product, $lastProductAdded.link_rewrite, $lastProductAdded.category, null, null, null, $lastProductAdded.id_product_attribute)|escape:'htmlall':'UTF-8'}{if $lastProductAdded.instructions_valid != ''}{if $awp_url_rewrite}?{else}&{/if}ipa={$lastProductAdded.id_product_attribute}&ins={$lastProductAdded.instructions_valid}{/if}">{$lastProductAdded.instructions|escape:'htmlspecialchars':'UTF-8'}</a>{/if}
		</div>
		<br class="clear" />
	</div>
{/if}
