...
<tr>
	...
	<td  class="{$classname} comparison_infos" align="center" >
		...
		<a href="{$base_url}?id_product={$id_product}&controller=product#idTab5" rel="#comments_{$id_product}" rel="#comments_{$id_product}" class="cluetip">{l s='view comments' mod='productcomments'}</a>
	{else}
		-
	{/if}
	</td>	
