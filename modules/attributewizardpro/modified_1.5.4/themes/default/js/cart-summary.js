...
function updateAddressId(id_product, id_product_attribute, old_id_address_delivery, id_address_delivery, line, instrcutions_valid)
{
	if (typeof(line) == 'undefined' || line.length == 0)
		line = $('#product_' + id_product + '_' + id_product_attribute + '_0_'+instrcutions_valid+'_' + old_id_address_delivery + ', #product_' + id_product + '_' + id_product_attribute + '_nocustom_' + old_id_address_delivery);
...
function updateCartSummary(json)
{
	...
	for (i in product_list)
	{
		...
		var key_for_blockcart = product_list[i].id_product+'_'+product_list[i].id_product_attribute+'_'+product_list[i].instructions_valid+'_'+product_list[i].id_address_delivery;
		var key_for_blockcart_nocustom = product_list[i].id_product + '_' + product_list[i].id_product_attribute+'_'+ ((product_list[i].quantity_without_customization != product_list[i].quantity)? 'nocustom' : '0') + '_' + product_list[i].instructions_valid + '_' + product_list[i].id_address_delivery;
