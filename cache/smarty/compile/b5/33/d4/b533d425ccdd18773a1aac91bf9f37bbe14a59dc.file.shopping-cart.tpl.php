<?php /* Smarty version Smarty-3.1.13, created on 2013-08-23 22:47:03
         compiled from "C:\wamp\www\fp-v1\themes\bestchoice\shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:291475217ca47855b68-66009244%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b533d425ccdd18773a1aac91bf9f37bbe14a59dc' => 
    array (
      0 => 'C:\\wamp\\www\\fp-v1\\themes\\bestchoice\\shopping-cart.tpl',
      1 => 1375189772,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '291475217ca47855b68-66009244',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5217ca486efde6_93430969',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5217ca486efde6_93430969')) {function content_5217ca486efde6_93430969($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\fp-v1\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
<?php if ($_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions_valid']!=''){?><?php if ($_smarty_tpl->tpl_vars['awp_url_rewrite']->value){?>?<?php }else{ ?>&<?php }?>ipa=<?php echo $_smarty_tpl->tpl_vars['lastProductAdded']->value['id_product_attribute'];?>
&ins=<?php echo $_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions_valid'];?>
<?php }?>"><img src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['lastProductAdded']->value['link_rewrite'],$_smarty_tpl->tpl_vars['lastProductAdded']->value['id_image'],'small_default');?>
...
<?php if ($_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions_valid']!=''){?><?php if ($_smarty_tpl->tpl_vars['awp_url_rewrite']->value){?>?<?php }else{ ?>&<?php }?>ipa=<?php echo $_smarty_tpl->tpl_vars['lastProductAdded']->value['id_product_attribute'];?>
&ins=<?php echo $_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions_valid'];?>
<?php }?>"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['lastProductAdded']->value['name'], 'htmlall', 'UTF-8');?>
</a></p>
...
<?php if ($_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions_valid']!=''){?><?php if ($_smarty_tpl->tpl_vars['awp_url_rewrite']->value){?>?<?php }else{ ?>&<?php }?>ipa=<?php echo $_smarty_tpl->tpl_vars['lastProductAdded']->value['id_product_attribute'];?>
&ins=<?php echo $_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions_valid'];?>
<?php }?>"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['lastProductAdded']->value['attributes'], 'htmlall', 'UTF-8');?>
</a><?php }?>
			<?php if (isset($_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions'])&&$_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions']){?><?php if ($_smarty_tpl->tpl_vars['lastProductAdded']->value['attributes']){?><br /><?php }?><a href="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['link']->value->getProductLink($_smarty_tpl->tpl_vars['lastProductAdded']->value['id_product'],$_smarty_tpl->tpl_vars['lastProductAdded']->value['link_rewrite'],$_smarty_tpl->tpl_vars['lastProductAdded']->value['category'],null,null,null,$_smarty_tpl->tpl_vars['lastProductAdded']->value['id_product_attribute']), 'htmlall', 'UTF-8');?>
<?php if ($_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions_valid']!=''){?><?php if ($_smarty_tpl->tpl_vars['awp_url_rewrite']->value){?>?<?php }else{ ?>&<?php }?>ipa=<?php echo $_smarty_tpl->tpl_vars['lastProductAdded']->value['id_product_attribute'];?>
&ins=<?php echo $_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions_valid'];?>
<?php }?>"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['lastProductAdded']->value['instructions'], 'htmlspecialchars', 'UTF-8');?>
</a><?php }?>
		</div>
		<br class="clear" />
	</div>
