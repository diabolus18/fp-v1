...
{if !$discounts}
	...
	<input type="hidden" name="item_name_{$i}" value="{$product.name}{if isset($product.attributes)} - {$product.attributes}{/if}{if $product.instructions != ""} - {$product.instructions}{/if}" />
