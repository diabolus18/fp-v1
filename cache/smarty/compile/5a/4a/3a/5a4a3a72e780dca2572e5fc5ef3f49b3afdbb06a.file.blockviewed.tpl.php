<?php /* Smarty version Smarty-3.1.13, created on 2013-07-19 13:58:37
         compiled from "C:\wamp\www\fp-v1\themes\bestchoice\modules\blockviewed\blockviewed.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2429351e929ed14b166-00111148%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5a4a3a72e780dca2572e5fc5ef3f49b3afdbb06a' => 
    array (
      0 => 'C:\\wamp\\www\\fp-v1\\themes\\bestchoice\\modules\\blockviewed\\blockviewed.tpl',
      1 => 1374235096,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2429351e929ed14b166-00111148',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51e929ed209c82_53712736',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51e929ed209c82_53712736')) {function content_51e929ed209c82_53712736($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\fp-v1\\tools\\smarty\\plugins\\modifier.escape.php';
?>
...
" />
					...
					<div class="text_desc">
						<h3 class="s_title_block"><a href="<?php echo $_smarty_tpl->tpl_vars['viewedProduct']->value->product_link;?>
" title="<?php echo smartyTranslate(array('s'=>'More about','mod'=>'blockviewed'),$_smarty_tpl);?>
 <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['viewedProduct']->value->name, 'html', 'UTF-8');?>
"><?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['viewedProduct']->value->name,30,'...'), 'html', 'UTF-8');?>
</a></h3>
						<p><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(strip_tags($_smarty_tpl->tpl_vars['viewedProduct']->value->description_short),44);?>
</p>
					</div>
				</li>
			<?php } ?>
