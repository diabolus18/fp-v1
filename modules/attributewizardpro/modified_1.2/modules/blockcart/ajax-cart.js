...
var ajaxCart = {
	...
	add : function(idProduct, idCombination, addedFromProductPage, callerElement, quantity, whishlist, instructions){
	...
	hideOldProductCustomizations : function (product, domIdProduct)
	{
		...
		if (!product.hasCustomizedDatas && !removeLinks.length)
			$('#' + domIdProduct + ' span.remove_link').html('<a class="ajax_cart_block_remove_link" href="' + baseDir + 'cart.php?delete&amp;id_product=' + product['id'] + '&amp;ipa=' + product['idCombination'] + '&amp;special_instructions=' + product['instructions_valid'] + '&amp;token=' + static_token + '" title="' + removingLinkText + '"> </a>');
	},
	...
	displayNewProducts : function(jsonData) {
		...
		$(jsonData.products).each(function(){
			//fix ie6 bug (one more item 'undefined' in IE6)
			if (this.id != undefined && this.name != undefined && this.name != "" && this.quantity != undefined && this.quantity != "" && String(this.id).search(/^\s*\d+\s*$/) != -1)			{
				...
				if($('#cart_block dt#cart_block_product_'+ domIdProduct ).length == 0)
				{
					...
					var content =  '<dt class="hidden" id="cart_block_product_' + domIdProduct + '">';
						 content += '<span class="quantity-formated"><span class="quantity">' + this.quantity + '</span>x</span>';
						  ...
						  content += '<span class="remove_link"><a class="ajax_cart_block_remove_link" href="' + baseDir + 'cart.php?delete&amp;id_product=' + productId + '&amp;token=' + static_token + (this.hasAttributes ? '&amp;ipa=' + parseInt(this.idCombination) : '') + (this.instructions ? '&amp;special_instructions=' + this.instructions_valid : '') + '"> </a></span>';
