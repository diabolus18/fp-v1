<?php /* Smarty version Smarty-3.1.13, created on 2013-09-26 10:46:15
         compiled from "C:\wamp\www\fp-v1\modules\blockcart\blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:277665243f457d44b97-29263348%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '04154a8b90c7ed2b6201256c3d9ebe670a747827' => 
    array (
      0 => 'C:\\wamp\\www\\fp-v1\\modules\\blockcart\\blockcart-json.tpl',
      1 => 1378299132,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '277665243f457d44b97-29263348',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5243f4585df515_42668895',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5243f4585df515_42668895')) {function content_5243f4585df515_42668895($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\fp-v1\\tools\\smarty\\plugins\\modifier.escape.php';
...
,
		"link":          "<?php echo smarty_modifier_replace(addslashes($_smarty_tpl->tpl_vars['product_link']->value),'\\\'','\'');?>
",
...
<?php echo html_entity_decode(ob_get_clean(),2,'UTF-8')?><?php }?>",
		"name":          "<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(mb_convert_encoding(htmlspecialchars(html_entity_decode($_smarty_tpl->tpl_vars['product']->value['name'],2,'UTF-8'), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8'),50,'...',true);?>
",
...
<?php if (isset($_smarty_tpl->tpl_vars['product']->value['instructions'])){?>
		"instructions":    "<?php echo smarty_modifier_replace(addslashes($_smarty_tpl->tpl_vars['product']->value['instructions']),'\\\'','\'');?>
",
		"instructions_valid":    "<?php echo addslashes($_smarty_tpl->tpl_vars['product']->value['instructions_valid']);?>
",
<?php }?>
...
",
						"truncatedValue":	"<?php echo smarty_modifier_replace(addslashes($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['data']->value['value'],50,'...')),'\\\'','\'');?>
"
...
",
		"name":            "<?php echo smarty_modifier_replace(addslashes($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate((($_smarty_tpl->tpl_vars['discount']->value['name']).(' : ')).($_smarty_tpl->tpl_vars['discount']->value['description']),50,'...')),'\\\'','\'');?>
",
		"description":     "<?php echo smarty_modifier_replace(addslashes($_smarty_tpl->tpl_vars['discount']->value['description']),'\\\'','\'');?>
",
		"nameDescription": "<?php echo smarty_modifier_replace(addslashes($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate((($_smarty_tpl->tpl_vars['discount']->value['name']).(' : ')).($_smarty_tpl->tpl_vars['discount']->value['description']),50,'...')),'\\\'','\'');?>
",
