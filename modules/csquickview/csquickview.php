...
class CsQuickView extends Module
{
	...
	public function hookHeader($params)
	{
		...
		$this->context->controller->addJs(__PS_BASE_URI__.'/js/jquery/plugins/fancybox/jquery.fancybox.js');
		$this->context->controller->addJs($this->_path.'js/cs_quickview.min.js');
