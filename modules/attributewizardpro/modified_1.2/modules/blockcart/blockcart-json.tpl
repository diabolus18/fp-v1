...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		'link':          '{$link->getProductLink($product.id_product, $product.link_rewrite, $product.category)|addslashes}{if $product.instructions_valid != ''}{if $link->getProductLink($product.id_product, $product.link_rewrite, $product.category)|strpos:'?' === false}?{else}&{/if}ipa={$productAttributeId}&ins={$product.instructions_valid}{/if}',
...
{if isset($product.instructions)}
		'instructions':    '{$product.instructions|addslashes}',
