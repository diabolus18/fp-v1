...
var ajaxCart = {
	...
	add : function(idProduct, idCombination, addedFromProductPage, callerElement, quantity, whishlist, instructions, instructions_id){
		...
		$.ajax({
			...
			cache: false,
			dataType : "json",
			data: 'add&ajax=true&qty=' + ( (quantity && quantity != null) ? quantity : '1') +( (instructions != null) ? '&special_instructions=' + instructions: '')+( (instructions_id != null) ? '&special_instructions_id=' + instructions_id: '')  + '&id_product=' + idProduct + '&token=' + static_token + ( (parseInt(idCombination) && idCombination != null) ? '&ipa=' + parseInt(idCombination): ''),
			success: function(jsonData)
			{
	...
	remove : function(idProduct, idCombination, customizationId, instructions){
		...
		$.ajax({
			...
			cache: false,
			dataType : "json",
			data: 'delete' + '&id_product=' + idProduct + '&special_instructions=' + instructions + '&ipa=' + ((idCombination != null && parseInt(idCombination)) ? idCombination : '') + ((customizationId && customizationId != null) ? '&id_customization=' + customizationId : '') + '&token=' + static_token + '&ajax=true',
