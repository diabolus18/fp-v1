		...
		<td style="width: 80%">
			...
			<table style="width: 70%" >
				...
				<tr style="line-height:6px;background-color:{cycle values='#FFF,#DDD'};">
					...
					<td style="width: 20%; text-align: right;">{displayPrice currency=$order->id_currency price=($order->payment_fee * ($order->payment_fee_rate/100) / (1+($order->payment_fee_rate/100)))}</td>
				</tr>
				{/if}
			</table>
			{/if}
