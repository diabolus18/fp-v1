<?php /* Smarty version Smarty-3.1.13, created on 2013-07-19 15:09:25
         compiled from "C:\wamp\www\fp-v1\modules\csquickview\views\templates\front\csproduct.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1680551e93a85bee423-09374134%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf0df5f0f9eea4b663982be348337f0d756d6e0c' => 
    array (
      0 => 'C:\\wamp\\www\\fp-v1\\modules\\csquickview\\views\\templates\\front\\csproduct.tpl',
      1 => 1374235259,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1680551e93a85bee423-09374134',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51e93a86b95b08_49594921',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51e93a86b95b08_49594921')) {function content_51e93a86b95b08_49594921($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\fp-v1\\tools\\smarty\\plugins\\modifier.escape.php';
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['packItem']->value['name'], 'htmlall', 'UTF-8');?>
		...
		<!-- add to cart form-->
		<form id="buy_block" target="_parent" <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value&&!isset($_smarty_tpl->tpl_vars['groups']->value)&&$_smarty_tpl->tpl_vars['product']->value->quantity>0){?>class="hidden"<?php }?> action="<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('cart');?>
" method="post">
 ...
 <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['product']->value->unity, 'htmlall', 'UTF-8');?>
			...
			<?php }else{ ?>
				<p id="add_to_cart" class="buttons_bottom_block">
					<span></span>
					<input type="submit" name="Submit" onclick="return closeFancy()" value="<?php echo smartyTranslate(array('s'=>'Add to cart'),$_smarty_tpl);?>
" class="exclusive" />
				</p>
			<?php }?>
