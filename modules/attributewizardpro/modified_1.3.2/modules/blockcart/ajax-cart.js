				...
				if($('#cart_block dt#cart_block_product_'+ domIdProduct ).length == 0)
				{
					...
					var content =  '<dt class="hidden" id="cart_block_product_' + domIdProduct + '">';
						 ...
						 var name = (this.name.length > 12 ? this.name.substring(0, 10) + '...' : this.name);
						  ...
						  content += '<span class="remove_link"><a class="ajax_cart_block_remove_link" href="' + baseDir + 'cart.php?delete&amp;id_product=' + productId + '&amp;token=' + static_token + (this.hasAttributes ? '&amp;ipa=' + parseInt(this.attributes) : '') + (this.instructions ? '&amp;special_instructions=' + this.instructions_valid : '') + '"> </a></span>';
