<?php /* Smarty version Smarty-3.1.13, created on 2013-08-01 09:00:42
         compiled from "C:\wamp\www\fp-v1\themes\bestchoice\products-comparison.tpl" */ ?>
<?php /*%%SmartyHeaderCode:975051fa079a2ec7a2-94186180%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1a6833dac3c0ac706abe0fbe81cae564a3f33adc' => 
    array (
      0 => 'C:\\wamp\\www\\fp-v1\\themes\\bestchoice\\products-comparison.tpl',
      1 => 1374235091,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '975051fa079a2ec7a2-94186180',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51fa079a7c75f4_88515499',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51fa079a7c75f4_88515499')) {function content_51fa079a7c75f4_88515499($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include 'C:\\wamp\\www\\fp-v1\\tools\\smarty\\plugins\\modifier.escape.php';
...
<div style="width: <?php echo sizeof($_smarty_tpl->tpl_vars['products']->value)*230+190;?>
px;" class="content_comapre">
	<table id="product_comparison">
	<tr>
			<td style="width:190px" class="td_empty"></td>
...
?>
			...
			<td style="width:230px" class="ajax_block_product comparison_infos<?php if ($_smarty_tpl->tpl_vars['i']->value==1){?> first<?php }?><?php if ($_smarty_tpl->tpl_vars['i']->value==count($_smarty_tpl->tpl_vars['products']->value)){?> last<?php }?>">
...
"/>
				...
				<h3><a href="<?php echo $_smarty_tpl->tpl_vars['product']->value->getLink();?>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value->name,40,'...'), 'htmlall', 'UTF-8');?>
				...
				<div class="product_desc"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['product']->value->description_short),100,'...');?>
</div>			
					...
					<?php if (isset($_smarty_tpl->tpl_vars['product']->value->show_price)&&$_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value){?>
						...
						<?php if ($_smarty_tpl->tpl_vars['product']->value->on_sale||($_smarty_tpl->tpl_vars['product']->value->specificPrice&&$_smarty_tpl->tpl_vars['product']->value->specificPrice['reduction'])){?>
