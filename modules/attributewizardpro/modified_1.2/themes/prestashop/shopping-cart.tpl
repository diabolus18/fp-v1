...
{if isset($lastProductAdded) AND $lastProductAdded}
	{foreach from=$products item=product}
		{if $product.id_product == $lastProductAdded.id_product AND (!$product.id_product_attribute OR ($product.id_product_attribute == $lastProductAdded.id_product_attribute)) AND (!$product.instructions OR ($product.instructions == $lastProductAdded.instructions))}
			...
			<table class="cart_last_product_content">
				<tr>
					<td class="cart_product"><a href="{$link->getProductLink($product.id_product, $product.link_rewrite, $product.category)|escape:'htmlall':'UTF-8'}{if $product.instructions_valid != ''}{if $awp_url_rewrite}?{else}&{/if}ipa={$product.id_product_attribute}&ins={$product.instructions_valid}{/if}"><img src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'small')}" alt="{$product.name|escape:'htmlall':'UTF-8'}" /></a></td>
					<td class="cart_description">
						<h5><a href="{$link->getProductLink($product.id_product, $product.link_rewrite, $product.category)|escape:'htmlall':'UTF-8'}{if $product.instructions_valid != ''}{if $awp_url_rewrite}?{else}&{/if}ipa={$product.id_product_attribute}&ins={$product.instructions_valid}{/if}">{$product.name|escape:'htmlall':'UTF-8'}</a></h5>
						{if $product.attributes}<a href="{$link->getProductLink($product.id_product, $product.link_rewrite, $product.category)|escape:'htmlall':'UTF-8'}{if $product.instructions_valid != ''}{if $awp_url_rewrite}?{else}&{/if}ipa={$product.id_product_attribute}&ins={$product.instructions_valid}{/if}">{$product.attributes|escape:'htmlall':'UTF-8'}</a>{/if}
						{if $product.instructions}{if $product.attributes}<br />{/if}<a href="{$link->getProductLink($product.id_product, $product.link_rewrite, $product.category)|escape:'htmlall':'UTF-8'}{if $product.instructions_valid != ''}{if $awp_url_rewrite}?{else}&{/if}ipa={$product.id_product_attribute}&ins={$product.instructions_valid}{/if}">{$product.instructions|escape:'htmlspecialchars':'UTF-8'}</a>{/if}
					</td>
				</tr>
			</table>
		{/if}
