<?php /* Smarty version Smarty-3.1.13, created on 2013-08-28 13:39:52
         compiled from "C:\wamp\www\fp-v1\themes\bestchoice\modules\blockcart\blockcart-json.tpl" */ ?>
<?php /*%%SmartyHeaderCode:14657521de18890b125-10592013%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8ad299adc76c671af918ec80a897cba18d7249c1' => 
    array (
      0 => 'C:\\wamp\\www\\fp-v1\\themes\\bestchoice\\modules\\blockcart\\blockcart-json.tpl',
      1 => 1375172589,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '14657521de18890b125-10592013',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_521de188d6a403_69032782',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_521de188d6a403_69032782')) {function content_521de188d6a403_69032782($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\wamp\\www\\fp-v1\\tools\\smarty\\plugins\\modifier.replace.php';
?>
...
<?php echo html_entity_decode(ob_get_clean(),2,'UTF-8')?><?php }?>",
		"name":          "<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate(mb_convert_encoding(htmlspecialchars(html_entity_decode($_smarty_tpl->tpl_vars['product']->value['name'],2,'UTF-8'), ENT_QUOTES, 'UTF-8', true), "HTML-ENTITIES", 'UTF-8'),35,'...',true);?>
",
